...
const Navbar = () => {
  ...
  return (
    ...
    <h1 className='hover:bg-white hover:text-blue-500 xs:py-5 py-2 xs:px-3 px-2 cursor-pointer text-center text-white'  onClick={()=>{router.push("/industries")}}>Industries</h1>
